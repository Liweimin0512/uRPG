...
void SpaceMgrBase::onComponentsEnterworld()
{
}

void SpaceMgrBase::onComponentsLeaveworld()
{
}

void SpaceMgrBase::onGetBase()
{
	if(pBaseEntityCall)
		delete pBaseEntityCall;

	pBaseEntityCall = new EntityBaseEntityCall_SpaceMgrBase(id(), className());
}

void SpaceMgrBase::onGetCell()
{
	if(pCellEntityCall)
		delete pCellEntityCall;

	pCellEntityCall = new EntityCellEntityCall_SpaceMgrBase(id(), className());
}

void SpaceMgrBase::onLoseCell()
{
	delete pCellEntityCall;
	pCellEntityCall = NULL;
}

EntityCall* SpaceMgrBase::getBaseEntityCall()
{
	return pBaseEntityCall;
}

EntityCall* SpaceMgrBase::getCellEntityCall()
{
	return pCellEntityCall;
}

void SpaceMgrBase::onRemoteMethodCall(MemoryStream& stream)
{
}

void SpaceMgrBase::onUpdatePropertys(MemoryStream& stream)
{
	ScriptModule* sm = *EntityDef::moduledefs.Find("SpaceMgr");
...
void SpaceMgrBase::callPropertysSetMethods()
{
...
void SpaceMgrBase::attachComponents()
{
}

void SpaceMgrBase::detachComponents()
{
}
